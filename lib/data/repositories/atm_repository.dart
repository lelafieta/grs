...
//   // Future<void> loadAtmStatusList() async {
...
//   //       throw ApiError(
//   //           statusCode: 401,
//   //           message: "Utilizador sem permissão, por favor faça login");
//   //     }

//   //     final dataModel = AtmDataModel.fromJson(jsonDecode(response.body));
//   //     atmStatusList = dataModel.getStatusWithMatchingAtmCodes();
//   //   } on TimeoutException {
//   //     throw "Utilizador sem permissão, por favor faça login";
//   //   } on SocketException {
//   //     throw "Verifique sua internet ou servidor";
//   //   } catch (e) {
//   //     throw e;
//   //   }
//   // }
...
//       print("${type} print ${atmType} print ${query}  print ${type}");
